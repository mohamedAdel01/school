...
import {GetClassrooms, AddTeacher} from "../../queries/queries"
const { Option } = Select
        ...
        {!this.props.GetClassrooms.loading && (
          <Row type='flex' justify='center' align='middle'>
            ...
            <form>
              ...
              <Select mode='multiple' style={{ width: '100%', 'marginTop': '10px'}} placeholder='select your classrooms' onChange={e => this.handleSelect(e, 'classrooms_ids')}>
              ...
              <p className="danger">{this.state.error.classrooms_ids}</p>
              {/* <Select mode='multiple' style={{ width: '100%', 'marginTop': '10px'}} placeholder='select grades' onChange={e => this.handleSelect(e, 'grades_ids')}>
                <Option key='1'>
                grades ids
                </Option>
              </Select> */}
              {/* <p className="danger">{this.state.error.grades_ids}</p> */}
              <Select style={{ width: '100%', 'marginTop': '10px'}} placeholder='select your subject' onChange={e => this.handleSelect(e, 'subject_id')}>
                {this.props.GetClassrooms.classrooms[5].subjects.map(subject => (
                  <Option key={subject.id}>
                    {subject.name}
                  </Option>
                ))}
              </Select>
              <p className="danger">{this.state.error.subject_id}</p>
...
export default compose(
  ...
  graphql(AddTeacher, {name: 'AddTeacher'})
)(Teacher_Signup)